...
cmake .. \
    ...
    -DPYTHON_LIBRARY="${python_root}/lib/python3.6" \
    -DPYTHON3_LIBRARY="${python_root}lib/python3.6" \
    -DPYTHON3_EXECUTABLE="${python_root}/bin/python" \
    -DPYTHON3_INCLUDE_DIR="${python_root}/include/python3.6m" \
    -DPYTHON3_INCLUDE_DIR2="${python_root}/include" \
    -DPYTHON3_NUMPY_INCLUDE_DIRS="${python_root}/lib/python3.6/site-packages/numpy/core/include" \
    -DPYTHON3_INCLUDE_PATH="${python_root}/include/python3.6m" \
